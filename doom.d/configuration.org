...
- add keybindings for narrow and widening of functions
...
- recursively fuzzy find file even if it is not in a project directory
- shortcut to go to the compilation buffer

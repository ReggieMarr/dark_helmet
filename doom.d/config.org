...
(use-package! transient
  ...
  (transient-define-prefix my/build ()
    ...
    ["Execute build"
     ("k" "kinetis" my/transient-suffix/build-kinetis)
     ("r" "release" my/ivy/compile)])

  (transient-define-prefix my/transient-suffix/build-kinetis ()
    ["Build Kinetis"
     ["Args"
      ("-B" "alway make" "--always-make")
      ("-j" "jobs" "--jobs")
      ("-c" "compiledb" "compiledb")]
     ["Project"
      ("c" "common servo" my/build-kinetis/ibst)
      ("t" "ibst" my/build-kinetis/ibst)]]))
...
(use-package! magit
  ...
  (define-key magit-mode-map (kbd "M-RET") 'magit-diff-visit-file-worktree)
